...
#all this is descriptive analysis

#dplyr
names(sales)  #typed in often because you dont always remember the entire data set
...
#Ans: CHIZ BROS INC most loyal with 253 times purchase
#n = n() will give the number of times each customer is there
