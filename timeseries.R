...
#Yearly----
(yearlysales = ts(sales, start=c(1980), frequency=1))   #frequency=1 means its a yearly series and c(1980) represents the start year
plot(yearlysales)
...
sales2 = rnorm(365, mean=100, sd=10)
(dailysales = ts(sales2, start=c(2017,1), frequency=365))
window(dailysales, start=c(2017,1), end=c(2017,1))
head(sales2)
tail(sales2)
