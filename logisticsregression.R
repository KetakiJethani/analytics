...
# gender not insignificant dropped here.. was determined because gender had a '.' before it while others had 3 stars.
...
cm = table(test_set[,5], y_pred)    #column 5 which had purchased 0 or 1
cm
