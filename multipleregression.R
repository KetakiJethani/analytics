...
par(mfrow=c(2,2))   #to have multiple graphs/plots in one area
plot(fit2)
par(mfrow=c(1,1))  #to showing the plots one by one i.e. to revert from the part which had all plots together.
plot(fit2)
omni[-c(11,14,15),]
...
#for selecting the relevant variables out of a large number of variables
...
#take his codes for anova and all
